...
*/
	...
	$demo_text = 'Create a red square in A5. Put a soldier in the left hand corner of the square.  Apply red to the soldier.  Make the soldier shoot bullets.';
	...
	if ($response['status'] == 'OK') {
		...
		foreach ($response['relations'] as $relation) {
			...
			if (array_key_exists('location', $relation)) {
				echo 'Location: ', $relation['location']['text'], PHP_EOL;
			}
			echo PHP_EOL;
		}
	} else {
